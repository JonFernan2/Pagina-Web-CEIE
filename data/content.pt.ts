export const FOOTER_PT = {
  ...
  col3: {
    ...
    links: [
      ...
      { label: 'Intensivo e à Medida',      href: '/pt/programas-e-cursos/intensivo' },
  ...
  programs: {
    ...
    items: [
      ...
      },
      {
        ...
        descripcion: 'Formação intensiva em grupo (online ou presencial) ou personalizada um a um. Adaptada ao nível, ritmo e objetivos de cada participante.',
        nivel: 'Todos os níveis',
        duracion: '2–3 semanas (grupal) · À medida (individual)',
        horario: 'Grupal: segunda a sexta · Individual: acordado com o estudante',
        grupoMax: '1–10 conforme modalidade',
        precioReferencial: 'Grupal a partir de USD 300 · Individual a partir de USD 1.000',
