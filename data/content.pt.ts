...
export const HOME_PT = {
  ...
  programs: {
    ...
    items: [
      ...
      },
      {
        ...
        descripcion: 'Imersão total em 4 a 8 semanas. Ideal para estudantes de intercâmbio e profissionais com tempo limitado que buscam avanço rápido.',
        nivel: 'A1 a B2',
      ...
      },
      {
        ...
        precioReferencial: 'Cotação institucional',
      ...
      },
      {
        ...
        precioReferencial: 'A partir de USD 38/hora',
  ...
  payment: {
    ...
    col3: {
      ...
      items: [
        'Com 30+ dias de antecedência: reembolso de 80%',
        'Com 15–29 dias: reembolso de 50%',
        'Com menos de 15 dias: sem reembolso',
      ],
      link: { label: 'Ver condições completas', href: '/pt/condicoes-contratacao' },
      disclaimer: '[PENDENTE — Valores e condições sujeitos a revisão pela assessoria jurídica da UAI]',
    },
  },
  accreditation: {
