...
export const FOOTER_EN = {
  ...
  col3: {
    ...
    links: [
      ...
      { label: 'Intensive & Tailored',    href: '/en/programs-and-courses/intensive' },
  ...
  programs: {
    ...
    items: [
      ...
      },
      {
        ...
        descripcion: 'Intensive group training (online or in-person) or personalized one-on-one. Adapted to each participant\'s level, pace, and objectives.',
        nivel: 'All levels',
        duracion: '2–3 weeks (group) · Flexible (individual)',
        horario: 'Group: Monday to Friday · Individual: agreed with the student',
        grupoMax: '1–10 depending on modality',
        precioReferencial: 'Group from USD 300 · Individual from USD 1,000',
