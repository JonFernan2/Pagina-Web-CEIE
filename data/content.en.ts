    ...
    items: [
      {
        ...
        precioReferencial: '[Consult]',
        href: '/en/programs-and-courses/semester',
      },
      {
        nombre: 'Intensive Program',
        descripcion: 'Total immersion in 4 to 8 weeks. Ideal for exchange students and professionals with limited time seeking rapid progress.',
        nivel: 'A1 to B2',
        duracion: '4–8 weeks',
      ...
      },
      {
        ...
        grupoMax: '1 student',
        precioReferencial: 'From USD 38/hr',
...
export const LEGAL_EN = {
  ...
  termsAndConditions: {
    ...
    sections: [
      { heading: 'Subject matter', body: '[PENDING — UAI legal counsel]' },
