export const FOOTER_ZH = {
  ...
  col2: {
    ...
    links: [
      ...
      { label: '课程招生通告',     href: 'https://postula.uai.cl/' },
    ],
  },
  col3: {
    title: '课程',
    links: [
      ...
      { label: '强化与定制课程',   href: '/zh/programs/intensive' },
...
export const HOME_ZH = {
  ...
  programs: {
    ...
    items: [
      ...
      {
        nombre: '强化与定制西班牙语课程',
        descripcion: '强化小组培训（在线或面授）或一对一个性化授课。根据每位学员的水平、节奏和目标量身定制。',
        nivel: '各级别均可',
        duracion: '2–3周（小组）· 定制安排（个人）',
        horario: '小组：周一至周五 · 个人：与学员协商',
        grupoMax: '1–10人（视授课模式而定）',
        precioReferencial: '小组起价 USD 300 · 个人起价 USD 1,000',
