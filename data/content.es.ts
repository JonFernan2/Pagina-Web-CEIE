...
export const FOOTER_ES = {
  ...
  col3: {
    ...
    links: [
      ...
      { label: 'Intensivo y a Medida',       href: '/programas-y-cursos/intensivo' },
  ...
  programs: {
    ...
    items: [
      ...
      },
      {
        ...
        descripcion: 'Formación intensiva en grupo (online o presencial) o personalizada uno a uno. Adaptada al nivel, ritmo y objetivos de cada participante.',
        nivel: 'Todos los niveles',
        duracion: '2–3 semanas (grupal) · A medida (individual)',
        horario: 'Grupal: lunes a viernes · Individual: acordado con el estudiante',
        grupoMax: '1–10 según modalidad',
        precioReferencial: 'Grupal desde USD 300 · Individual desde USD 1.000',
