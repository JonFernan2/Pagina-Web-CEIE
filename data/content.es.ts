    ...
    items: [
      {
        ...
        precioReferencial: 'Consultar',
        href: '/programas-y-cursos/semestral',
      },
      {
        nombre: 'Programa Intensivo',
        descripcion: 'Inmersión total en 4 a 8 semanas. Ideal para estudiantes de intercambio y profesionales con tiempo limitado que buscan avance rápido.',
        nivel: 'A1 a B2',
        duracion: '4–8 semanas',
        horario: '5 días/semana, 4 horas diarias',
      ...
      },
      {
        ...
        descripcion: 'Español para negocios, diplomacia, investigación académica o sectores específicos. Diseñados para organizaciones y grupos institucionales.',
        nivel: 'Según requerimiento institucional',
        duracion: 'Mínimo 40 horas',
        horario: 'Coordinado con la organización cliente',
        grupoMax: 'Variable según convenio',
        precioReferencial: 'Cotización institucional',
        href: '/programas-y-cursos/fines-especificos',
      },
      {
        nombre: 'Programa Individual — ELE a Medida',
        descripcion: 'Clases individuales diseñadas según los objetivos, nivel y disponibilidad del estudiante. Disponible en campus o en modalidad in-situ en la sede del cliente.',
        nivel: 'Todos los niveles',
        duracion: 'Flexible',
        horario: 'Acordado con el estudiante',
        grupoMax: '1 estudiante',
        precioReferencial: 'Desde USD 38/hora',
