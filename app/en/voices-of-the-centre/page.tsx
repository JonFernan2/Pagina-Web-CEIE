        ...
        <div className="max-w-ceie mx-auto px-4 md:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mx-auto" style={{ maxWidth: '1100px' }}>
            <div>
              ...
              <p className="text-xs mt-2 font-body" style={{ color: '#6B6B6B' }}>Credits: Mathias Adolf Harboe Damian</p>
            </div>
            <div>
              <div className="overflow-hidden" style={{ borderRadius: '4px', border: '1px solid #E5E3DE', position: 'relative' }}>
                <div style={{ position: 'relative', paddingBottom: '56.25%', overflow: 'hidden' }}>
                  <iframe
                    ...
                    title="International student testimonial — CEIE UAI"
                    allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"
                    allowFullScreen
                    style={{ position: 'absolute', top: 0, left: 0, width: '100%', height: '100%', border: 'none', display: 'block' }}
                  />
              ...
              <p className="text-xs mt-2 font-body" style={{ color: '#6B6B6B' }}>Student testimonial · CEIE UAI</p>
            </div>
          </div>
        </div>
      </section>
