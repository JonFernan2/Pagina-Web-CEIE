              ...
              <div style={{ background: '#FFFFFF', borderRadius: '4px', padding: '20px 24px' }}>
                <div className="flex items-center gap-5">
                  ...
                  <div style={{ borderLeft: '1px solid #D1CFC9', paddingLeft: '20px' }}>
                    ...
                    <p className="font-body font-semibold text-negro text-sm">Acreditada 6 anos</p>
                    <p className="font-body text-xs leading-relaxed mt-1" style={{ color: '#4a4a4a' }}>
                      Áreas: Gestão institucional, Docência de graduação, Docência de pós-graduação, Pesquisa e Vinculação com a comunidade. Até outubro de 2027.
                    </p>
                  </div>
                </div>
              </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-start">
            ...
            <div className="w-full aspect-video overflow-hidden" style={{ borderRadius: '4px', border: '2px solid #6493b5' }}>
              <img
                ...
                alt="Vista aérea do Campus UAI Viña del Mar — Padre Hurtado 750"
      ...
      <section style={{ background: '#C7C2ba' }} className="py-16">
        <div className="max-w-ceie mx-auto px-4 md:px-6 lg:px-8 text-center">
          ...
          <p className="text-base leading-relaxed mb-8 mx-auto" style={{ color: '#2D2D2D', maxWidth: '560px' }}>
            Tem interesse em fazer parte da equipe CEIE? Confira nossas vagas abertas e candidate-se pelo portal oficial da Universidad Adolfo Ibáñez.
          </p>
          <a
