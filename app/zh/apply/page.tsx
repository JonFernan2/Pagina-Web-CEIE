...
export default function ApplyZHPage() {
  ...
  return (
    <>
      <Navbar lang="zh" currentPath="/zh/apply" />
      ...
      <section style={{ background: '#C7C2ba' }} className="py-16">
        <div className="max-w-ceie mx-auto px-4 md:px-6 lg:px-8">
          <h2 className="font-display font-bold text-negro text-3xl mb-10 text-center">申请流程</h2>
              ...
              >
                ...
                <div className="flex items-start gap-2">
                  ...
                  <label htmlFor="privacy" className="text-sm" style={{ color: '#6B6B6B' }}>
                    ...
                    <Link href="/zh/privacy-policy" className="underline" style={{ color: '#6493b5' }}>（查看政策）</Link>
                  </label>
                </div>
