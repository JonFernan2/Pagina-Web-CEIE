...
export default function ProgramCard({
  ...
  return (
    ...
    >
      ...
      <div
        className="px-6 py-4"
        style={{ borderBottom: '2px solid #C5A028', background: '#1A1A1A' }}
      >
      ...
      <div className="flex flex-col flex-1 px-6 py-5 gap-4">
        ...
        <div className="flex flex-col gap-2 text-sm">
          <div className="flex items-start gap-2">
            <Clock size={14} className="mt-0.5 shrink-0" style={{ color: '#C5A028' }} />
            <div>
          ...
          <div className="flex items-start gap-2">
            <Users size={14} className="mt-0.5 shrink-0" style={{ color: '#C5A028' }} />
            <div>
        ...
        <div className="mt-auto pt-4" style={{ borderTop: '1px solid #E5E3DE' }}>
          ...
          <p className="text-xl font-bold" style={{ color: '#C5A028' }}>
            {precioReferencial}
          </p>
        </div>
